$( document ).ready(function() {
     ...
     GROUP_ACTION_PHRASE = {
         'Fleet': 'caught',
         'Fish Harvester': 'caught',
         'Shellfish Grower': 'harvested',
         'Processor': 'Processed',
         'Distributor': 'distributed',
         'Wholesaler': 'wholesaled',
         'Retailer': 'sold',
         'Restaurant': 'served',
         'Restaurant': 'served',
         'Consumer': 'consumed',
             ...
             for(i=0, len=data.ind_events.length; i<len; i++){
               ...
               if (ev.location){
                 ...
                 TRACE.locations.push({
                   ...
                   label: (ev.group ? GROUP_ACTION_PHRASE[ev.group.name] : '')+"<br/> in <b>"+ev.location.name+"</b>"
                 });
               }
             }
